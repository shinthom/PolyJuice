...
async function main() {
  ...
  const fulfillFromBorrowerAndRepay = async () => {
    console.log(
      "\nstarting making bidding (from lender) ⬇️\n===================================================================================================================================="
    );
    let biddingFromLender = await makeBidding(lender, {
...
- erc20(borrower) : ${await contracts.erc20.balanceOf(
    ...
    console.log(
      "\nstarting repayment (from borrower) ⬇️\n===================================================================================================================================="
    );
...
- erc20(borrower) : ${await contracts.erc20.balanceOf(
    ...
    await childERC721.connect(borrower).repay(id);
...
- erc20(borrower) : ${await contracts.erc20.balanceOf(
  ...
  const fulfillFromBorrowerAndClaim = async () => {
    console.log(
      "\nstarting making bidding (from lender) ⬇️\n===================================================================================================================================="
    );
    let biddingFromLender = await makeBidding(lender, {
...
- erc20(borrower) : ${await contracts.erc20.balanceOf(
    ...
    await childERC721.connect(lender).repay(id);
...
- erc20(borrower) : ${await contracts.erc20.balanceOf(
  ...
  const fulfillFromLenderAndRepay = async () => {
    console.log(
      "\nstarting making bidding (from lender) ⬇️\n===================================================================================================================================="
    );
    let biddingFromBorrower = await makeBidding(borrower, {
      ...
      amount: 100,
      listingExpiration: 0,
      biddingExpiration: Math.floor(Date.now() / 1000) + 86400, // + 1 day,
      duration: 86400, // 1 day
    });
...
- erc20(borrower) : ${await contracts.erc20.balanceOf(
  ...
  const fulfillFromLenderAndClaim = async () => {
    console.log(
      "\nstarting making bidding (from lender) ⬇️\n===================================================================================================================================="
    );
    let biddingFromBorrower = await makeBidding(borrower, {
...
- erc20(borrower) : ${await contracts.erc20.balanceOf(
  ...
  await fulfillFromBorrowerAndRepay();
  // await fulfillFromBorrowerAndClaim();
  // await fulfillFromLenderAndRepay();
  // await fulfillFromLenderAndClaim();
}
