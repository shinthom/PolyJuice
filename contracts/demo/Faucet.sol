...
contract Faucet {
    ...
    IChildERC721 private _firstChildERC721;
    IChildERC721 private _secondChildERC721;
    IChildERC721 private _thirdChildERC721;

    constructor(
        address payable admin,
        IERC20 usdc,
        IERC721 motherERC721,
        IChildERC721 firstChildERC721,
        IChildERC721 secondChildERC721,
        IChildERC721 thirdChildERC721
    ) payable {
        _admin = admin;
    ...
    function faucet (address to, uint256 ethAmount, uint256 usdcAmount) external {
        ...
        // NOTE: childERC721 cannot be transferred.
        ...
        _firstChildERC721.mint(_tokenId);
